...
<description>Selects examples from the data set based on conditions</description>
...
class OWSelectData(OWWidget):
    ...
    def __init__(self, parent = None, signalManager = None, name = "Select data"):
        ...
        self.purgeClassesCB = OWGUI.checkBox(OWGUI.indentedBox(boxSettings), self, "purgeClasses", "Also remove unused values on class", callback=self.OnPurgeChange)
...
if __name__=="__main__":
    ...
    data = dataUtilities.DataTable('../../doc/datasets/adult_sample.tab')
