...
QSARNEXTFOLDS = 10     #Number of Folds for the outer loop where data is splitted into Esternal test and Modeling Set
...
QSARSTABILITYTHRESHOLD = 0.1    #Max stability balue for a model to be considered stable
